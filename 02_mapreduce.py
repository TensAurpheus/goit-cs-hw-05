...
async def map_reduce(url):
    ...
    with ThreadPoolExecutor() as executor:
        mapped_result = await asyncio.gather(*[loop.run_in_executor(executor, map_function, word) for word in words])
        mapped_result = [(await future) for future in mapped_result]
